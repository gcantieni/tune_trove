// One-time script to produce assets/data/pringle_tunes.json from
// John Chambers' ABC transcription of John Pringle's Collection.
//
// "John Pringle's Collection of Reels Strathspey & Jigs" (1801).
// Courtesy of John Chambers.
//
// Usage:
//   dart lib/remote_tune_sources/pringle_scrape.dart
//
...
const _url = 'https://trillian.mit.edu/~jc/music/book/Pringle/tunes.abc';
const _outPath = 'assets/data/pringle_tunes.json';

void main() async {
  final client = http.Client();
  try {
    stdout.writeln('Downloading tunes.abc...');
