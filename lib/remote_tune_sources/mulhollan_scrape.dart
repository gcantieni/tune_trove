// One-time script to produce assets/data/mulhollan_tunes.json from
// John Chambers' ABC transcription of the John Macpherson Mulhollan Collection.
//
// "Airs and Melodies Peculiar to the Highlands and The Isles" (1814)
// by John Macpherson Mulhollan. Courtesy of John Chambers.
//
// Usage:
//   dart lib/remote_tune_sources/mulhollan_scrape.dart
//
...
const _url =
    'https://trillian.mit.edu/~jc/music/book/JohnMacphersonMulhollan/IaST-abc2.abc';
const _outPath = 'assets/data/mulhollan_tunes.json';

void main() async {
  final client = http.Client();
  try {
    stdout.writeln('Downloading IaST-abc2.abc...');
